...
/// <summary>
/// Minimal P0 chat window (windows/PORT-PLAN.md Fase 5): a prompt box, the
/// transcript, and the live activity panel, wired to <see cref="ChatViewModel"/>.
/// No repo picker yet — defaults to the user's home directory; no settings UI
/// (model/effort/permission-mode are hardcoded sane defaults) — those are
/// follow-up work, not part of this minimal slice.
/// </summary>
